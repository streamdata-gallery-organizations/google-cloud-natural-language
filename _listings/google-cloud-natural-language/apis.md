...
- name: Google Cloud Natural Language API Analyze Syntax
  x-api-slug: google-cloud-natural-language-api
  description: |-
...
- name: Google Cloud Natural Language API Annotate Text
  x-api-slug: google-cloud-natural-language-api
  description: |-
...
- name: Google Cloud Natural Language API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-organizations/google-cloud-natural-language/master/_listings/google-cloud-natural-language/openapi.md
x-common:
- type: x-change-log
